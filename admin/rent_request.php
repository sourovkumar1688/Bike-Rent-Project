  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <?php  
          $select_query = "SELECT * FROM bike_booking WHERE booking_status = 'pending' ";
           ...
           $select_bike_query = "SELECT * FROM all_bikes WHERE bike_id = $bike_id ";
            ...
            ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="?confirm=<?php echo $booking_id; ?>"><button class="btn btn-danger">Confirm</button></a>
                      </td>
                      <td>
          ...
          <?php }else{
            ...
            echo "<h1 style='color:red;text-align:center;'>No Rent Request Found</h1>";
          }
...
<?php 
  ...
  if (isset($_GET['confirm'])) {
    $rent_id = $_GET['confirm'];

    $update_qry = "UPDATE bike_booking SET booking_status = 'confirmed' WHERE booking_id=$rent_id ";
    $result = $db->update($update_qry);
    if ($result) {
      echo '<script type="text/javascript">Swal.fire({
          icon: "success",
          title: "successful",
          text: "Rent Rent Confirmed",
          })
          setTimeout(function(){
            window.location.href = "rent_request.php";
            }, 2000);
