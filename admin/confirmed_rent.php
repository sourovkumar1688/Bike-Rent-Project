  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-md-12">
          <?php  
          $select_query = "SELECT * FROM bike_booking WHERE booking_status = 'confirmed' ";
          ...
          <?php }else{
            ...
            echo "<h1 style='color:red;text-align:center;'>Not Found On Going Rent</h1>";
          }
...
<?php 
  ...
  if (isset($_GET['complete'])) {
    ...
    if ($result) {
      $update_qry1 = "UPDATE all_bikes SET status = 'available' WHERE bike_id=$bike_id ";
        $result1 = $db->update($update_qry1);
      echo '<script type="text/javascript">Swal.fire({
          icon: "success",
          title: "successful",
